        ...
        <div className="container pt-4 mb-4">
                <section className="row">
                    <div className="ml-1 card col-lg-7 col-m-12 col-sm-12">
                        ...
                        <h2 className="mt-3 ml" style={{color:"#59aaa5"}}>About Me</h2>
                    </div>
                            <div className="col-lg-6 col-md-6 col-sm-12 card-body">
                        <img className="float-left aboutPic" src="images/myPic.png" alt="Picture of Wesley Tejeda, thumbs up!" />
                            </div>
                            <article className="pb-4 mb-2">
                        ...
                        <p className="pt-1">Email: Wesley.Tejeda95@gmail.com</p>
                    </div>
                </section>
        </div>
            )
